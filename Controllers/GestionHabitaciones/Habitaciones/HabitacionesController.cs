    ...
    public class HabitacionesController : ControllerBase
    {
        ...
        public IActionResult All()
        {
            try
            {
                ...
                {
                    using (SqlCommand cmd = new SqlCommand("gh.crudHabitaciones", conn))
                    {
        ...
        public IActionResult Create(dynamic request)
        {
            try
            {
                using (SqlConnection conn = MainConnection.Connection(_configuration))
                {
                    using (SqlCommand cmd = new SqlCommand("gh.crudHabitaciones", conn))
                    {
                        cmd.Parameters.AddWithValue("@tipoHabitacion", (Int32)request.tipoHabitacion);
                        ...
                        cmd.Parameters.AddWithValue("@precio", (string)request.precio);
