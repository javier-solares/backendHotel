...
namespace dw_backend.Controllers.Administracion.Calendario
{
    ...
    public class CalendarioController : ControllerBase
    {
        ...
        public IActionResult All()
        {
            try
            {
                ...
                {
                    using (SqlCommand cmd = new SqlCommand("adm.crudCalendario", conn))
                    {
            ...
            try
            {
                using (SqlConnection conn = MainConnection.Connection(_configuration))
                {
                    using (SqlCommand cmd = new SqlCommand("adm.crudCalendario", conn))
                    {
                        ...
                        cmd.Parameters.AddWithValue("@fecha", (string)request.fecha);
