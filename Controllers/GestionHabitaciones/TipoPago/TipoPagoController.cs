...
namespace dw_backend.Controllers.Administracion.TipoPago
{
    ...
    public class TipoPagoController : ControllerBase
    {
        ...
        public TipoPagoController(IConfiguration configuration)
        {
        ...
        public IActionResult All()
        {
            try
            {
                ...
                {
                    using (SqlCommand cmd = new SqlCommand("adm.crudTipoPago", conn))
                    {
