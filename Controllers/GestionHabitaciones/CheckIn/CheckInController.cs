...
namespace dw_backend.Controllers.Administracion.TipoPersona
{
    ...
    public class CheckInController : ControllerBase
    {
        ...
        public IActionResult All()
        {
            try
            {
                ...
                {
                    using (SqlCommand cmd = new SqlCommand("adm.crudCheckIn", conn))
                    {
            ...
            try
            {
                using (SqlConnection conn = MainConnection.Connection(_configuration))
                {
                    using (SqlCommand cmd = new SqlCommand("adm.crudCheckIn", conn))
                    {
                        ...
                        cmd.Parameters.AddWithValue("@fechaEntrada", (string)request.fechaEntrada);
                        cmd.Parameters.AddWithValue("@comentario", (string)request.comentario);
                        //cmd.Parameters.AddWithValue("@empleados", (Int32)request.empleados);
