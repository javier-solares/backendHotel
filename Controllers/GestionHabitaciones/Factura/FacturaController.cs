...
namespace dw_backend.Controllers.Administracion.Factura
{
    ...
    [ApiController]
    public class FacruraController : ControllerBase
    {
        private IConfiguration _configuration;
        private readonly string _commandText;
        public FacruraController(IConfiguration configuration)
        {
        ...
        public IActionResult All()
        {
            try
            {
                ...
                {
                    using (SqlCommand cmd = new SqlCommand("adm.crudfactura", conn))
                    {
            ...
            try
            {
                using (SqlConnection conn = MainConnection.Connection(_configuration))
                {
                    using (SqlCommand cmd = new SqlCommand("adm.crudfactura", conn))
                    {
                        ...
                        cmd.Parameters.AddWithValue("@fechaEmision", (string)request.fechaEmision);                      
