...
namespace dw_backend.Controllers.Administracion.Rol
{
    ...
    public class RolController : ControllerBase
    {
        ...
        public RolController(IConfiguration configuration)
        {
            ...
            //_commandText = _configuration.GetValue<string>("DataBase:StoredProcedures:Rol");
        }
        ...
        public IActionResult All()
        {
            try
            {
                ...
                {
                    using (SqlCommand cmd = new SqlCommand("adm.crudRol", conn))
                    {
        ...
        [Produces("application/json")]
        //[Authorize]
        public IActionResult Create(RolModel request)
        {
            try
            {
                using (SqlConnection conn = MainConnection.Connection(_configuration))
        ...
        [Produces("application/json")]
        //[Authorize]
        public IActionResult Update(RolModel request)
        {
            try
            {
                using (SqlConnection conn = MainConnection.Connection(_configuration))
