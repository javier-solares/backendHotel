...
//namespace dw_backend.Controllers.Administracion.Departamento
//{
...
//            _nameProcedure = "adm.crudDepartamento";
//        }
...
//                catch (Exception ex)
//                {
//                    result = newResponses.Payback(1001, ex.ToString());
...
//                        {
//                            result = newResponses.Payback(7001, null);
//                            return BadRequest(result.Payback());
//                        }
//                    }
//                    catch (Exception ex)
//                    {
//                        result = newResponses.Payback(1002, ex.ToString());
//                        return BadRequest(result.Payback());
//                    }

//                    if (setter.Tables["tabla"].Rows.Count <= 0)
//                    {
//                        result = newResponses.Payback(2009, null);
//                        return BadRequest(result.Payback());
//                    }
...
//                        catch (Exception ex)
//                        {
//                            result = newResponses.Payback(1003, ex.ToString());
//                            return BadRequest(result.Payback());
//                        }
//                        if (setter.Tables["tabla"].Rows.Count <= 0)
//                        {
