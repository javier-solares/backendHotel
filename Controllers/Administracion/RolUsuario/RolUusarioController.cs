...
namespace dw_backend.Controllers.Administracion.RolUsuario
{
    ...
    public class RolUsuarioController : ControllerBase
    {
        ...
        public RolUsuarioController(IConfiguration configuration)
        {
        ...
        public IActionResult All()
        {
            try
            {
                ...
                {
                    using (SqlCommand cmd = new SqlCommand("adm.crudrolUsuario", conn))
                    {
        ...
        public IActionResult Create(dynamic request)
        {
            try
            {
                using (SqlConnection conn = MainConnection.Connection(_configuration))
                {
                    using (SqlCommand cmd = new SqlCommand("adm.crudrolUsuario", conn))
                    {
                        cmd.Parameters.AddWithValue("@usuario", (int)request.id);
                        cmd.Parameters.AddWithValue("@rol", (string)request.rol);
