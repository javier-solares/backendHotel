...
namespace dw_backend.Controllers.Administracion.Moneda
{
    ...
    public class MonedaController : ControllerBase
    {
        ...
        public IActionResult All()
        {
            try
            {
                ...
                {
                    using (SqlCommand cmd = new SqlCommand("adm.crudMoneda", conn))
                    {
        ...
        public IActionResult Create(dynamic request)
        {
            try
            {
                using (SqlConnection conn = MainConnection.Connection(_configuration))
                {
                    using (SqlCommand cmd = new SqlCommand("adm.crudMoneda", conn))
                    {
                        cmd.Parameters.AddWithValue("@pais", (string)request.pais);
