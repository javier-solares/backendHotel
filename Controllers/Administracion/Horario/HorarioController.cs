...
namespace dw_backend.Controllers.Administracion.Horario
{
    ...
    public class HorarioController : ControllerBase
    {
        ...
        public IActionResult All()
        {
            try
            {
                ...
                {
                    using (SqlCommand cmd = new SqlCommand("adm.crudHorario", conn))
                    {
            ...
            try
            {
                using (SqlConnection conn = MainConnection.Connection(_configuration))
                {
                    using (SqlCommand cmd = new SqlCommand("adm.crudHorario", conn))
                    {
                        ...
                        cmd.Parameters.AddWithValue("@DiaSemana", (string)request.DiaSemana);
                        cmd.Parameters.AddWithValue("@HoraEntrada", (string)request.HoraEntrada);
                        cmd.Parameters.AddWithValue("@HoraSalida", (string)request.HoraSalida);                     
